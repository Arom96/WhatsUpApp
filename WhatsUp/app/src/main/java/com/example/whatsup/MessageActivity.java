...
import com.example.whatsup.adapter.UserAdapter;
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!msg.equals("")){
                    ...
                    Toast.makeText(MessageActivity.this, "Mensaje vacío", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                if (user.getImageURL().equals("default")){
                    profile_image.setImageResource(R.mipmap.ic_perfil);
                }else {
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                ...
                try {
                    for (DataSnapshot snapshot : datasnapshot.getChildren()){
                        ...
                        Toast.makeText(MessageActivity.this, "" + chat.getReceiver(), Toast.LENGTH_SHORT).show();
                        if (chat != null){
